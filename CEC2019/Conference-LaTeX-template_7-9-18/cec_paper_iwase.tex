...
\author{\IEEEauthorblockN{1\textsuperscript{st} Takuya Iwase}
\IEEEauthorblockA{\textit{The Univ. of Electro-Communications} \\
% \textit{name of organization (of Aff.)}\\
Tokyo, Japan \\
tanu\_iwa@cas.lab.uec.ac.jp}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Ryo Takano}
\IEEEauthorblockA{\textit{The Univ. of Electro-Communications} \\
% \textit{name of organization (of Aff.)}\\
Tokyo, Japan \\
takano@cas.lab.uec.ac.jp}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Fumito Uwano}
\IEEEauthorblockA{\textit{The Univ. of Electro-Communications} \\
% \textit{name of organization (of Aff.)}\\
Tokyo, Japan \\
uwano@cas.lab.uec.ac.jp}
\and
\IEEEauthorblockN{4\textsuperscript{th} Hiroyuki Sato}
\IEEEauthorblockA{\textit{The Univ. of Electro-Communications} \\
% \textit{name of organization (of Aff.)}\\
Tokyo, Japan \\
h.sato@uec.ac.jp}
\and
\IEEEauthorblockN{5\textsuperscript{th} Keiki Takadama}
\IEEEauthorblockA{\textit{The Univ. of Electro-Communications} \\
% \textit{name of organization (of Aff.)}\\
Tokyo, Japan \\
keiki@hc.uec.ac.jp}
...
\subfigure[Fitness Landscape]{
	\includegraphics[width=0.9\linewidth]{eps/3d_himmelblau.eps}
	\label{fig:3d_himmelblau}
}
\subfigure[Contour Plot]{
	\includegraphics[width=0.9\linewidth]{eps/cont_himmelblau.eps}
...
\begin{center}
\subfigure[Fitness Landscape]{
	\includegraphics[width=0.9\linewidth]{eps/3d_shubert.eps}
	\label{fig:3d_shubert}
}
\subfigure[Contour Plot]{
	\includegraphics[width=0.9\linewidth]{eps/cont_shubert.eps}
...
\begin{center}
\subfigure[Fitness Landscape]{
	\includegraphics[width=0.9\linewidth]{eps/3d_vincent.eps}
	\label{fig:3d_vincent}
}
\subfigure[Contour Plot]{
	\includegraphics[width=0.9\linewidth]{eps/cont_vincent.eps}
...
\begin{center}
\subfigure[Fitness Landscape]{
	\includegraphics[width=0.9\linewidth]{eps/3d_rastrigin.eps}
	\label{fig:3d_rastrigin}
}
\subfigure[Contour Plot]{
	\includegraphics[width=0.9\linewidth]{eps/cont_rastrigin.eps}
