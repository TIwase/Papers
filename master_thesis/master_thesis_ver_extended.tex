...
\label{sec:nm}
本章では，前述したMetaheuristic Algorithmに対し，Niching schemeを組み合わせた複数解探索手法について説明する．
...
本章では他の最先端手法と探索性能を比較するため，複数解探索手法のコンペティション(CEC Competition 2013)で使用された手法に着目する．実験環境をCEC Competition 2013で用いられた評価関数，評価指標に合わせて実験を行った．
