...
\label{ss:cde}
Crowding DE (CDE) \cite{CDE} は類似個体同士を比較し，評価値の高い方を残すことで，複数解探索を行う手法である．
...
\begin{algorithm}[H]
\caption{Crowding Differential Evolution (DE/rand/1)}
\label{code:cde}
\begin{algorithmic}[3]
\REQUIRE Objective Function $F(x), x=(x_1,x_2,...,x_d)$
\STATE Initialize Population $x_i (i=1,2,...,N)$ and Velocity $v_i$
...
\subsection{Parameterless-Niching-Assisted NSGAII}
\label{ss:PNA-NSGA}
...
& & goptima & loptima & & \\
\hline
$F_1$ & 0 & 1 & 16 &  2 & $x \in [-10,10]$  \\
\hline
$F_2$ & 0 & 1 & 120 & 2 & $x \in [-5,5]$  \\
\hline
$F_3$ & -1.0316 & 2 & 2 & 2 & $x_1 \in [-2,2]$  \\
& & & & & $x_2 \in [-1,1]$ \\
\hline
$F_4$ & -1.8013 & 1 & 2 & 2 & $x,y \in [0,4]$  \\
\hline
$F_5$ & 0 & 4 & 0 & 2 & $x \in [-5,5]$, \\
\hline
\end{tabular}
\label{tab:minMOP}
\end{center}
...
Function & $F(x_*)$ & Num of & $\rho$ & $D$ & Search Range \\
& & goptima & & & \\
\hline
$F_1$ & 200.0 & 2 & 0.01 & 1 & $x \in [0,30]$  \\
\hline
$F_2$ & 1.0 & 5 & 0.01 & 1 & $x \in [0,1]$  \\
\hline
$F_3$ & 1.0 & 1 & 0.01 & 1 & $x \in [0,1]$  \\
\hline
$F_4$ & 200.0 & 4 & 0.01 & 2 & $x,y \in [-6,6]$  \\
\hline
$F_5$ & 1.03163 & 2 & 0.5 & 2 & $x \in [-1.9,1.9]$, \\
& & & & & $y \in [-1.1,1.1]$ \\
\hline
$F_6$ & 186.731 & 18 & 0.5 & 2 & $x_i \in [-10,10]$  \\
\hline
...
\begin{equation}
d_i^{t} = \frac {1}{N} \sum _{j=1}^N \frac {(x_{pbest}-x_j^{t})}{|x_{pbest}-x_j^{t}|^2}
\label{eq:nd*}
\end{equation}
\begin{equation}
...
\subsubsection{評価関数}
\label{sss:NSBA-func}
本実験では\ref{ss:MinFunc}節で説明した$F_1$: Griewank関数と$F_2$: Rastrigin関数を用いる．
...
% \centering
% \subfigure[Fitness Landscape]{
% \includegraphics[width=0.8\linewidth]{eps/IES2018/3d_griewank.eps}
% \label{fig:nsba-f1(3d)}}
% \subfigure[Contour Plot]{
% \includegraphics[width=0.8\linewidth]{eps/IES2018/cont_griewank.eps}
% \label{fig:nsba-f1(2d)}}
% \caption{Griewank関数}
% \label{fig:nsba-f1}
% \end{figure}
...
% \centering
% \subfigure[Fitness Landscape]{
% \includegraphics[width=0.8\linewidth]{eps/IES2018/3d_rastrigin.eps}
% \label{fig:nsba-f2(3d)}}
% \subfigure[Contour Plot]{
% \includegraphics[width=0.8\linewidth]{eps/IES2018/cont_rastrigin.eps}
% \label{fig:nsba-f2(2d)}}
% \caption{Rastrigin関数}
% \label{fig:nsba-f2}
% \end{figure}
...
\subsubsection{解の分布}
図\ref{fig:nsba-all_iter}よりPR値を維持できない原因を分析するため，ここではPR値が最も高かった1000世代目の解分布に着目し，その時の分布図を図\ref{fig:nsba-results_nsba_1000}に示す．
...
\subsubsection{評価関数}
\label{sss:NRBA-func}
本実験で使用するベンチマーク関数は，\ref{tab:minMOP}節で説明した$F_1$: Griewank，$F_3$: Six-Hump Camel，$F_4$: Michalewicz，$F_5$: Himmelblauの4つを用いる．

% \begin{figure}[t]
% \centering
% \subfigure[Fitness Landscape]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/3d_griewank.eps}
% \label{fig:nrba-f1(3d)}}
% \subfigure[Contour Plot]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/cont_griewank.eps}
% \label{fig:nrba-f1(2d)}}
% \caption{Griewank関数}
% \label{fig:nrba-f1}
% \end{figure}
...
% \centering
% \subfigure[Fitness Landscape]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/3d_sixhump_camel.eps}
% \label{fig:nrba-f2(3d)}}
% \subfigure[Contour Plot]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/cont_sixhump_camel.eps}
% \label{fig:nrba-f2(2d)}}
% \caption{Six-Hump Camel関数}
% \label{fig:nrba-f2}
% \end{figure}
...
% \centering
% \subfigure[Fitness Landscape]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/3d_michalewicz.eps}
% \label{fig:nrba-f3(3d)}}
% \subfigure[Contour Plot]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/cont_michalewicz.eps}
% \label{fig:nrba-f3(2d)}}
% \caption{Michalewicz関数}
% \label{fig:nrba-f3}
% \end{figure}
...
% \centering
% \subfigure[Fitness Landscape]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/3d_himmelblau.eps}
% \label{fig:nrba-f4(3d)}}
% \subfigure[Contour Plot]{
% \includegraphics[width=0.8\linewidth]{eps/SICESSI2018/cont_himmelblau.eps}
% \label{fig:nrba-f4(2d)}}
...
\hline
$F_1$ & 0.0588 $\pm$ 0 & 0.3760 $\pm$ 0.0413 & 0.6922 $\pm$ 0.0981  \\
\hline
$F_3$ & 0.4917 $\pm$ 0.0449 & 0.5 $\pm$ 0 & 0.9917 $\pm$ 0.0449 \\
\hline
$F_4$ & 0.5 $\pm$ 0 & 0.5 $\pm$ 0 & 0.7 $\pm$ 0.2450 \\
\hline
$F_5$ & 0.2417 $\pm$ 0.1367 & 1 $\pm$ 0 & 0.8583 $\pm$ 0.1239 \\
\hline
\end{tabular}
\label{tab:nrba}
\end{center}
...
Function & $F(x*)$ & Num of & $\rho$ & $D$ & Search Range \\
& & goptima & & & \\
\hline
$F_1$ & 200.0 & 2 & 0.01 & 1 & $x \in [0,30]$  \\
\hline
...
本コンペティションではPR \cite{CEC2013} によりアルゴリズムの性能評価を行う．各評価関数で割り当てられた評価回数 (MaxFEs) と {\it accuracy level} $\varepsilon$を用いてPRは次式で表される．
\begin{equation}
\label{eq:PR}
