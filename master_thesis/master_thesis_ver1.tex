...
Function & $F(x*)$ & Num of & Num of & $\rho$ & Dimension & Search Range \\
& & goptima & loptima & & & \\
\hline
$F_1$ & 200.0 & 2 & 3 & 0.01 & 1 & $x \in [0,30]$  \\
\hline
$F_2$ & 1.0 & 5 & 0 & 0.01 & 1 & $x \in [0,1]$  \\
\hline
$F_3$ & 1.0 & 1 & 4 & 0.01 & 1 & $x \in [0,1]$  \\
\hline
$F_4$ & 200.0 & 4 & 0 & 0.01 & 2 & $x,y \in [-6,6]$  \\
\hline
$F_5$ & 1.03163 & 2 & 2 & 0.5 & 2 & $x \in [-1.9,1.9]$, \\
& & & & & & $y \in [-1.1,1.1]$ \\
\hline
$F_6$ & 186.731 & 18 & 0 & 0.5 & 2 & $x_i \in [-10,10]$  \\
\hline
% \multicolumn{4}{l}{$^{\mathrm{a}}$Sample of a Table footnote.}
\end{tabular}
\label{tab:MOP}
