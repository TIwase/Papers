...
% このNiche countより，Shared fitness $f_i'$が次式のように算出される．
% \begin{equation}
% \label{eq:sfit}
% \phi_i=\frac{F_i}{m_i}
% \end{equation}
...
\bibitem{DNS} B. Miller, "Genetic algorithms with dynamic niche sharing for multimodal function optimization", {\it In: Proceedings of the 1996 IEEE International Conference on Evolutionary Computation (ICEC’96)}, 1996.
